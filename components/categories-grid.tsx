      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {CATEGORIES.map(({ icon: Icon, label, desc }) => (
            <div
              key={label}
              className="group bg-[#0f2a44] border border-white/10 rounded-2xl p-6 flex flex-col items-start gap-3 hover:border-[#0ea5e9]/50 hover:bg-[#122d47] transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#0ea5e9]/10"
            >
              <div className="w-11 h-11 bg-[#0ea5e9]/10 rounded-xl flex items-center justify-center group-hover:bg-[#0ea5e9]/20 transition-colors">
