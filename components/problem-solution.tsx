    ...
    <section className="bg-white py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="text-3xl sm:text-[2.5rem] font-bold text-[#0f2a44] leading-[1.15]">
        ...
        {/* Three points, editorial columns with dividers */}
        ...
        {/* Solution bridge */}
        <div className="mt-8 rounded-2xl bg-[#0f2a44] p-10 sm:p-14">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold text-[#0ea5e9] uppercase tracking-widest mb-3">
              The platform
            </p>
            <h3 className="text-2xl sm:text-[2rem] font-bold text-white leading-[1.2]">
            ...
            <a
              href="#waitlist-form"
              className="mt-8 inline-flex items-center gap-2 text-[#0ea5e9] font-semibold hover:gap-3 transition-all"
            >
